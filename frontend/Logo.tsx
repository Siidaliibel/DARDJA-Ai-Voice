  ...
  >
    <defs>
      ...
      <radialGradient id="dotGlow">
        ...
        <stop offset="100%" stopColor="#E81A1A" />
      </radialGradient>
    </defs>
    ...
    <circle cx="50" cy="40" r="0.8" fill="#FFF" opacity="0.5" />
    <circle cx="150" cy="40" r="0.8" fill="#FFF" opacity="0.5" />
    <circle cx="100" cy="20" r="1" fill="#1A73E8" opacity="0.9" />
    <circle cx="160" cy="110" r="0.7" fill="#FFF" opacity="0.4" />
    <circle cx="40" cy="110" r="0.7" fill="#FFF" opacity="0.4" />
