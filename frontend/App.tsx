...
const handleTryExample1 = () => {
  setScriptText(
    "كامل نحبو نوثقو اللحظات الجميلة لي نعيشوهاو خاصة كي نكونو في البحر ولا في la piscine،ولّا في مغامرة.لأول مرة، mini camera sport متوفرة في الجزائر، خفيفة، صغيرة، وتصورك من منظورك،مُجهزة بغلاف بلاستيكي ضد الماء، وتستحمل عمق يفوت 30 متريعني سواء كنت تحب الغطس، تسبح، ولا تلعب فالأمواج، الكاميرا معاك وتخدم بلا ما تخاف عليها.وإذا كنت من الناس لي تحب تصوّر وهي تمارس الرياضةكيما لاعبي كرة القدم، الكرة الطائرة، الدرّاجين، أو المتزلجين...هذي الكاميرا تلبسها في الرقبة، ولا تثبّتها على الكاسك، و مستحيل تَتْنَحى من مكانها، وتصور كل حركة بجودة ممتازة ،بزاوية واسعة، وبدون ما تشدّها بْيَدَّكْ،الكاميرا متوفرة عندنا بكمية محدودة، cliquez على زر الشراء عَمَّر المعلومات، و التوصيل 58 ولاية، مرحبا بالجميع."
  );
};
